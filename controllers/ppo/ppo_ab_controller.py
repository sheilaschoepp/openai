...
class AbnormalController:
    ...
    def run(self):
        ...
        for _ in itertools.count(1):
            ...
            max_steps_this_episode = min(1000, self.parameters["n_time_steps"] + 500000 - self.rlg.num_steps())  # todo
            ...
            if self.rlg.num_steps() == self.parameters["n_time_steps"] + 500000:  # todo
