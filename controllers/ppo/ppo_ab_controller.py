...
class AbnormalController:
    ...
    def evaluate_model(self, num_time_steps):
        ...
        if self.parameters["eval_episodes"] != 0:
            ...
            index = ((num_time_steps - self.parameters["n_time_steps"] // 10000) +
                     (self.parameters["n_time_steps"] // self.parameters["time_step_eval_frequency"]) +
                     1)  # add 1 because we evaluate policy before learning  todo
