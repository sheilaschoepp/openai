...
from controllers.ppov1.ppov1_networks import ActorCriticNetwork
from utils.memory import Memory
from utils.rl_glue import BaseAgent


class PPOv1(BaseAgent):
    """
    ...
    def __init__(self,
        ...
        # network
        self.actor_critic_network = ActorCriticNetwork(state_dim, action_dim, hidden_dim, std).to(device=self.device)
    ...
    def agent_save_num_updates(self, dir_):
        ...
        update_dic = {"num_updates": self.num_updates,
