...
from controllers.ppov1.ppov1_agent import PPOv1
...
parser.add_argument("--std", type=float, default=1.0, metavar="G",
                    help="standard deviation of the policy distribution (default: 1.0)")

parser.add_argument("-ef", "--time_step_eval_frequency", type=int, default=1000, metavar="N",
                    help="frequency of policy evaluation during learning (default: 1000)")
...
class NormalController:
    ...
    def __init__(self):
        ...
        # agent
        self.agent = PPOv1(self.env.env_state_dim(),
        ...
        print("std:", highlight_non_default_values("std"))
