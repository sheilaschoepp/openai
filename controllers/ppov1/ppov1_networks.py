...
class PolicyNetwork(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, hidden_dim, std):
        """
        ...
        @param hidden_dim: int
            hidden layer dimension
        @param std: float
            standard deviation of the policy distribution
        """
        ...
        self.variance = nn.Parameter(torch.full((action_dim,), std**2))
...
class ActorCriticNetwork(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, hidden_dim, std):
        ...
        self.policy_network = PolicyNetwork(state_dim, action_dim, hidden_dim, std)
    ...
    def evaluate(self, state, action):
        ...
        variance = self.policy_network.variance.expand_as(mean)
    ...
    def sample(self, state, deterministic=False):
        ...
        covariance = torch.diag(self.policy_network.variance)
