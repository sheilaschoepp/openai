...
class AbnormalController:
    ...
    def __init__(self):
        ...
        if not args.resume:
            ...
            self.parameters["time_step_eval_frequency"] = 10000
            self.parameters["time_step_model_save_frequency"] = 10000
    ...
    def evaluate_model(self, num_time_steps):
        ...
        if self.parameters["eval_episodes"] != 0:
            ...
            index = int((num_time_steps - 20000000) / self.parameters["time_step_eval_frequency"]) + 1 + 200  # add 1 because we evaluate policy before learning
