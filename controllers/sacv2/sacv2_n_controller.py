...
parser.add_argument("-ef", "--time_step_eval_frequency", type=int, default=100000, metavar="N",
...
parser.add_argument("-msf", "--time_step_model_save_frequency", type=int, default=1000000, metavar="N",
