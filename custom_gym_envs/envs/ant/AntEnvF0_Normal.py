"""
modifications:
- changed class name from "AntEnv" to "AntEnvF0"
...
class AntEnvF0(MujocoEnv, utils.EzPickle): # modification: changed class name from "AntEnv" to "AntEnvF0"
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(
        self,
        xml_file: str = "/home/sschoepp/Documents/openai/custom_gym_envs/envs/ant/xml/AntEnvF0_Normal.xml", # modification: changed xml_file from "ant.xml" to "{path}"
        frame_skip: int = 5,
