"""
modifications:
- changed class name from "AntEnv" to "AntEnvF1"
...
class AntEnvF1(MujocoEnv, utils.EzPickle): # modification: changed class name from "AntEnv" to "AntEnvF1"
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(
        self,
        xml_file: str = "/home/sschoepp/Documents/openai/custom_gym_envs/envs/ant/xml/AntEnvF1_Ankle4ROM.xml", # modification: changed xml_file from "ant.xml" to "{path}"
        frame_skip: int = 5,
