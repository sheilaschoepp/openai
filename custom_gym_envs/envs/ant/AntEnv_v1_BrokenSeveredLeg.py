...
class AntEnvV1(mujoco_env.MujocoEnv, utils.EzPickle):  # todo: renamed to AntEnvV1
    def __init__(self):
        home = str(Path.home())
        filepath = home + "/Documents/openai/custom_gym_envs/envs/ant/xml/AntEnv_v1_brokenleg.xml"  # todo: modified xml filepath
