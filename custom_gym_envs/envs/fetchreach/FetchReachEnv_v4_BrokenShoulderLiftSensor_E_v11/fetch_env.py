...
class FetchEnv(robot_env.RobotEnv):
    ...
    def compute_reward(self, achieved_goal, goal, info):
        ...
        shoulder_lift_position = 1.5

        error_shoulder_lift = np.abs(shoulder_lift_position - info['qpos_dict']['robot0:shoulder_lift_joint'])
    

        if error_shoulder_lift < 0.1:  # Allowable error threshold
