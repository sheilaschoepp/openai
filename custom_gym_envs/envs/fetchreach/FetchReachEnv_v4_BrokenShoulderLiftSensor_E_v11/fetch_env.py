...
from custom_gym_envs.envs.fetchreach.FetchReachEnv_v4_BrokenShoulderLiftSensor_E_v11 import robot_env, rotations, utils  # modification here
...
class FetchEnv(robot_env.RobotEnv):
    ...
    def compute_reward(self, achieved_goal, goal, info):
        ...
        shoulder_lift_joint_target = 1.5

        shoulder_lift_joint_current = info['qpos_dict']['robot0:shoulder_lift_joint']
    

        if shoulder_lift_joint_current == shoulder_lift_joint_target:

            shoulder_lift_reward = 0

        else:

            shoulder_lift_reward = -1 * np.abs(shoulder_lift_joint_current - shoulder_lift_joint_target)
    

        return -d + shoulder_lift_reward, -d
