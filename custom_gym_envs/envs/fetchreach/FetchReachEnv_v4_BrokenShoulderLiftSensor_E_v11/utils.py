...
def robot_get_obs(sim):
    ...
    if sim.data.qpos is not None and sim.model.joint_names:
        ...
        qfrc_constraint = sim.data.qfrc_constraint
        qfrc_con = {n:qfrc_constraint[names.index(n)] for n in names if n.endswith('joint')}
        ...
        return qpos, qvel, qpos_dict, qvel_dict, actuator_torques, qfrc_con
