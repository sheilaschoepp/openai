...
from custom_gym_envs.envs.fetchreach.FetchReachEnv_v4_BrokenShoulderLiftSensor_E_v13 import fetch_env  # modification here
...
class FetchReachEnv(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='dense'):
        ...
        fetch_env.FetchEnv.__init__(
            ...
            obj_range=0.15, target_range=0.15, distance_threshold=0.001,
