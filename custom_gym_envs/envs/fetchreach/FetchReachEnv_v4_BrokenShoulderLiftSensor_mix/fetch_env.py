...
from custom_gym_envs.envs.fetchreach.FetchReachEnv_v4_BrokenShoulderLiftSensor_mix import robot_env, rotations, utils  # modification here
...
class FetchEnv(robot_env.RobotEnv):
    ...
    def compute_reward(self, achieved_goal, goal, info):
        ...
        qvel_faulty = info['qvel_dict']['robot0:shoulder_lift_joint']

        penalty = np.abs(qvel_faulty)
