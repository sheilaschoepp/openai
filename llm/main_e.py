...
if __name__ == "__main__":
    ...
    expert_function = retriever.retrieve_and_verify_function_expert(main_prompt)
    function_code_v1 = retriever.retrieve_and_verify_function(main_prompt)
    ...
    new_directory_name_v1 = 'FetchReachEnv_v1_BrokenElbowFlexJoint_LLM_e_v1'
    # new_directory_name_v2 = 'FetchReachEnv_v1_BrokenElbowFlexJoint_LLM_e_v2'
    expert_directory_name = 'FetchReachEnv_v1_BrokenElbowFlexJoint_e_Expert'
