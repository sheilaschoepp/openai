...
if __name__ == "__main__":
    ...
    #
    # plot(title="ppo: (1) 50% lr reduction (2) default param ", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="ppo: (1) 50% lr reduction (2) pss 33 ", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: AntEnv-v1", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: AntEnv-v2", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: AntEnv-v3", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: AntEnv-v4", df_mean=df_mean, df_sem=df_sem, ymin=-1000, ymax=8000)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="ppo: goal dist 0.001", df_mean=df_mean, df_sem=df_sem, ymin=-15, ymax=5)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="ppo: goal dist 0.005", df_mean=df_mean, df_sem=df_sem, ymin=-15, ymax=5)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: goal dist 0.001", df_mean=df_mean, df_sem=df_sem, ymin=-15, ymax=5)
    #
    ...
    # df_mean, df_sem = get_data(data_dir)
    #
    # plot(title="sac: goal dist 0.005", df_mean=df_mean, df_sem=df_sem, ymin=-15, ymax=5)
