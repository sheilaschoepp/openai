...
import openai.custom_gym_envs  # DO NOT DELETE
...
def forward_kinematics(thread_sim, thread_points, index_i, index_j, index_k, index_l, index_m, index_n, index_o):
    ...
    thread_sim.data.set_joint_qpos("robot0:shoulder_pan_joint", index_l)
    thread_sim.data.set_joint_qpos("robot0:shoulder_lift_joint", index_m)
    thread_sim.data.set_joint_qpos("robot0:elbow_flex_joint", index_n)
