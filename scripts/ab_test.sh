#!/bin/bash
# filepath: /home/afraz1/Documents/openai/scripts/llm_test_single_env.sh

# Constants
PPO_CONTROLLER_ABSOLUTE_PATH="controllers/ppo/ppo_ab_controller.py"
FULLENVIRONMENT="PPO_FetchReachEnv-v20:100000_lr:0.000275_lrd:False_slrd:1.0_g:0.848_ns:3424_mbs:8_epo:24_eps:0.3_c1:1.0_c2:0.0007_cvl:False_mgn:0.5_gae:True_lam:0.9327_hd:64_lstd:0.0_tef:1750_ee:10_tmsf:50000000_d:cpu_ps:True_pss:43"
ENVIRONMENT="FetchReachEnv-v20"
TOTAL_SEEDS=15
WINDOWS=10
...
launch_window() {
    ...
    for seed in $(seq $start_seed $end_seed); do
        local full_command="python $PPO_CONTROLLER_ABSOLUTE_PATH \
            -e $ENVIRONMENT \
            -t 250000 \
            --file /home/afraz1/Documents/openai/data/${FULLENVIRONMENT}/seed${seed}"
        
        tmux send-keys -t mix_exp:"$window_name" "$full_command" C-m
        tmux send-keys -t mix_exp:"$window_name" "echo 'Completed: $ENVIRONMENT with seed $seed'" C-m
    done
