...
#  ur3
  "--ab_env_name=Ant-F3 --ab_time_steps=40000000 --wandb"
  "--ab_env_name=Ant-F3 --ab_time_steps=40000000 --wandb --clear_memory"
  "--ab_env_name=Ant-F3 --ab_time_steps=40000000 --wandb --reinitialize_networks"
  "--ab_env_name=Ant-F3 --ab_time_steps=40000000 --wandb --reinitialize_networks --clear_memory"
)
