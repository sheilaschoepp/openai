...
BASE_ARGS_LIST=(
  "--ab_env_name=FetchReach-F1 --ab_time_steps=400000 --wandb"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=400000 --wandb --clear_memory"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=400000 --wandb --reinitialize_networks"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=400000 --wandb --clear_memory --reinitialize_networks"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=400000 --wandb"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=400000 --wandb --clear_memory"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=400000 --wandb --reinitialize_networks"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=400000 --wandb --clear_memory --reinitialize_networks"
)
