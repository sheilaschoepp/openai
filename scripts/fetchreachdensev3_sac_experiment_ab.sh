...
BASE_ARGS_LIST=(
  "--ab_env_name=FetchReach-F1 --ab_time_steps=40000 --wandb"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=40000 --wandb --clear_replay_buffer"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=40000 --wandb --reinitialize_networks"
  "--ab_env_name=FetchReach-F1 --ab_time_steps=40000 --wandb --clear_replay_buffer --reinitialize_networks"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=40000 --wandb"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=40000 --wandb --clear_replay_buffer"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=40000 --wandb --reinitialize_networks"
  "--ab_env_name=FetchReach-F2 --ab_time_steps=40000 --wandb --clear_replay_buffer --reinitialize_networks"
)
