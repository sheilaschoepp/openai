...
tmux new-session -d -s sacv1-10 "CUDA_VISIBLE_DEVICES=6 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed10 -t 20000000 --resumable -crb"
tmux new-session -d -s sacv1-11 "CUDA_VISIBLE_DEVICES=6 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed11 -t 20000000 --resumable -crb"
tmux new-session -d -s sacv1-12 "CUDA_VISIBLE_DEVICES=6 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed12 -t 20000000 --resumable -crb"
tmux new-session -d -s sacv1-13 "CUDA_VISIBLE_DEVICES=6 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed13 -t 20000000 --resumable -crb"
tmux new-session -d -s sacv1-14 "CUDA_VISIBLE_DEVICES=6 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed14 -t 20000000 --resumable -crb"
tmux new-session -d -s sacv1-10 "CUDA_VISIBLE_DEVICES=7 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed10 -t 20000000 --resumable -rn"
tmux new-session -d -s sacv1-11 "CUDA_VISIBLE_DEVICES=7 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed11 -t 20000000 --resumable -rn"
tmux new-session -d -s sacv1-12 "CUDA_VISIBLE_DEVICES=7 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed12 -t 20000000 --resumable -rn"
tmux new-session -d -s sacv1-13 "CUDA_VISIBLE_DEVICES=7 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed13 -t 20000000 --resumable -rn"
tmux new-session -d -s sacv1-14 "CUDA_VISIBLE_DEVICES=7 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed14 -t 20000000 --resumable -rn"
tmux new-session -d -s sacv1-10 "CUDA_VISIBLE_DEVICES=5 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed10 -t 20000000 --resumable -crb -rn"
tmux new-session -d -s sacv1-11 "CUDA_VISIBLE_DEVICES=5 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed11 -t 20000000 --resumable -crb -rn"
tmux new-session -d -s sacv1-12 "CUDA_VISIBLE_DEVICES=5 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed12 -t 20000000 --resumable -crb -rn"
tmux new-session -d -s sacv1-13 "CUDA_VISIBLE_DEVICES=5 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed13 -t 20000000 --resumable -crb -rn"
tmux new-session -d -s sacv1-14 "CUDA_VISIBLE_DEVICES=5 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed14 -t 20000000 --resumable -crb -rn"
