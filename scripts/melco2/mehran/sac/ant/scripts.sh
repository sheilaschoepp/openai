...
tmux new-session -d -s sacv1-10 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed10 -t 20000000 -d"
tmux new-session -d -s sacv1-11 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed11 -t 20000000 -d"
tmux new-session -d -s sacv1-12 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed12 -t 20000000 -d"
tmux new-session -d -s sacv1-12_crb_rn "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed12 -t 20000000 -crb -rn -d"
tmux new-session -d -s sacv1-13_crb_rn "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed13 -t 20000000 -crb -rn -d"
tmux new-session -d -s sacv1-14_crb_rn "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v1 -f $RESUME_FILE/seed14 -t 20000000 -crb -rn -d"
...
#tmux new-session -d -s sacv2-4 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed4 -d"
#tmux new-session -d -s sacv2-5 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed5 -d"
#tmux new-session -d -s sacv2-6 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed6 -d"
#tmux new-session -d -s sacv2-7 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed7 -d"
#tmux new-session -d -s sacv2-8 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed8 -d"
#tmux new-session -d -s sacv2-9 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v2 -t 20000000 --resumable -f $RESUME_FILE/seed9 -d"

# ------------------------ V3

#tmux new-session -d -s sacv3-0 "CUDA_VISIBLE_DEVICES=0 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed0 -d"
#tmux new-session -d -s sacv3-1 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed1 -d"
#tmux new-session -d -s sacv3-2 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed2 -d"
#tmux new-session -d -s sacv3-3 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed3 -d"
#tmux new-session -d -s sacv3-4 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed4 -d"
#tmux new-session -d -s sacv3-5 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed5 -d"
#tmux new-session -d -s sacv3-6 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed6 -d"
#tmux new-session -d -s sacv3-7 "CUDA_VISIBLE_DEVICES=1 python $SAC_AB_CONTROLLER_ABSOLUTE_PATH -c -e AntEnv-v3 -t 20000000 --resumable -f $RESUME_FILE/seed7 -d"
