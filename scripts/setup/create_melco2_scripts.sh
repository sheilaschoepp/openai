...
do
  echo 'tmux new-session -d -s ps88'$s' "python $PPO_N_CONTROLLER_ABSOLUTE_PATH -e FetchReach-v1 -lrd -s '$s' -t 6000000 -tef 30000 -tmsf 100000 -ps -pss 88"' >> melco2.sh
done

for s in 4 5 6 7 8 9
do
  echo 'tmux new-session -d -s ps86'$s' "python $PPO_N_CONTROLLER_ABSOLUTE_PATH -e FetchReach-v1 -lrd -s '$s' -t 6000000 -tef 30000 -tmsf 100000 -ps -pss 86"' >> melco2.sh
done
...
for s in 3 4 5 6 7 8 9
do
  echo 'tmux new-session -d -s ps58'$s' "python $PPO_N_CONTROLLER_ABSOLUTE_PATH -e FetchReach-v1 -lrd -s '$s' -t 6000000 -tef 30000 -tmsf 100000 -ps -pss 58"' >> melco2.sh
done

for s in 5 6 7 8 9
do
  echo 'tmux new-session -d -s ps21'$s' "python $PPO_N_CONTROLLER_ABSOLUTE_PATH -e FetchReach-v1 -lrd -s '$s' -t 6000000 -tef 30000 -tmsf 100000 -ps -pss 21"' >> melco2.sh
done

for s in 7 8 9
do
  echo 'tmux new-session -d -s ps91'$s' "python $PPO_N_CONTROLLER_ABSOLUTE_PATH -e FetchReach-v1 -lrd -s '$s' -t 6000000 -tef 30000 -tmsf 100000 -ps -pss 91"' >> melco2.sh
done
